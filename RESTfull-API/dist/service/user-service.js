...
const register = (request) => __awaiter(void 0, void 0, void 0, function* () {
    const user = (0, validation_1.validate)(user_validation_1.registerUserValidaton, request);
    // logger.info(request)
...
const login = (request) => __awaiter(void 0, void 0, void 0, function* () {
    const loginRequest = yield (0, validation_1.validate)(user_validation_1.loginUserValidation, request);
...
const update = (request) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let data = yield database_1.prismaClient.user.findUnique({
        where: {
            username: user.username
        }
    });
